...
import (
	...
	"github.com/agurha/tunnel/pkg/msg"
	"github.com/agurha/tunnel/pkg/util"
	"github.com/agurha/tunnel/pkg/version"
)
...
func NewControl(ctlConn conn.Conn, authMsg *msg.Auth) {
	...
	if authMsg.Version != version.Proto {
		failAuth(fmt.Errorf("Incompatible versions. Server %s, client %s. Download a new version at http://ezzytunnel.com", version.MajorMinor(), authMsg.Version))
		return
	}
